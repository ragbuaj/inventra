...
mixin _$RequestDto {
 ...
 String get id; String get type; String get status; String? get amount;@JsonKey(name: 'current_step') int get currentStep;@JsonKey(name: 'office_id') String? get officeId;@JsonKey(name: 'target_id') String? get targetId;@JsonKey(name: 'target_entity') String? get targetEntity; String? get reason;@JsonKey(name: 'requested_by_id') String get requestedById;@JsonKey(name: 'requested_by_name') String? get requestedByName;@JsonKey(name: 'requested_by_role') String? get requestedByRole;@JsonKey(name: 'office_name') String? get officeName;@JsonKey(name: 'decided_by_id') String? get decidedById;@JsonKey(name: 'decision_note') String? get decisionNote;@JsonKey(name: 'created_at') DateTime? get createdAt;
...
class _RequestDto implements RequestDto {
  const _RequestDto({required this.id, required this.type, required this.status, this.amount, @JsonKey(name: 'current_step') required this.currentStep, @JsonKey(name: 'office_id') this.officeId, @JsonKey(name: 'target_id') this.targetId, @JsonKey(name: 'target_entity') this.targetEntity, this.reason, @JsonKey(name: 'requested_by_id') required this.requestedById, @JsonKey(name: 'requested_by_name') this.requestedByName, @JsonKey(name: 'requested_by_role') this.requestedByRole, @JsonKey(name: 'office_name') this.officeName, @JsonKey(name: 'decided_by_id') this.decidedById, @JsonKey(name: 'decision_note') this.decisionNote, @JsonKey(name: 'created_at') this.createdAt});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RequestDto&&(identical(other.id, id) || other.id == id)&&(identical(other.type, type) || other.type == type)&&(identical(other.status, status) || other.status == status)&&(identical(other.amount, amount) || other.amount == amount)&&(identical(other.currentStep, currentStep) || other.currentStep == currentStep)&&(identical(other.officeId, officeId) || other.officeId == officeId)&&(identical(other.targetId, targetId) || other.targetId == targetId)&&(identical(other.targetEntity, targetEntity) || other.targetEntity == targetEntity)&&(identical(other.reason, reason) || other.reason == reason)&&(identical(other.requestedById, requestedById) || other.requestedById == requestedById)&&(identical(other.requestedByName, requestedByName) || other.requestedByName == requestedByName)&&(identical(other.requestedByRole, requestedByRole) || other.requestedByRole == requestedByRole)&&(identical(other.officeName, officeName) || other.officeName == officeName)&&(identical(other.decidedById, decidedById) || other.decidedById == decidedById)&&(identical(other.decisionNote, decisionNote) || other.decisionNote == decisionNote)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt));
}
