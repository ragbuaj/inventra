...
_RequestDetailDto _$RequestDetailDtoFromJson(Map<String, dynamic> json) =>
    _RequestDetailDto(
      ...
      steps:
          (json['steps'] as List<dynamic>?)
              ?.map((e) => RequestStepDto.fromJson(e as Map<String, dynamic>))
              .toList() ??
          const <RequestStepDto>[],
    );

Map<String, dynamic> _$RequestDetailDtoToJson(_RequestDetailDto instance) =>
    <String, dynamic>{
      'id': instance.id,
      'type': instance.type,
