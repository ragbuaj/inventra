...
- Spec bagian 2 (data model) → Task 1, 2. bagian 3 (authz) → Task 8 `PermissionKey`, Task 14 handler checks, Task 10–13 scope in validation, Task 20 tests. bagian 4 (backend engine) → Tasks 4–9, 14, 15. bagian 4.2 (asset approval flow) → Task 10 + Task 15 executor wiring. bagian 4.3 (endpoints) → Task 14, 16. bagian 4.4 (asset validation rules) → Task 10. bagian 5 (frontend) → Tasks 17–19. bagian 6 (error handling) → Tasks 5, 9, 14, 18. bagian 7 (testing) → Tasks 4–14 unit, 20 integration, 21 e2e. bagian 8 (out of scope) → respected (intangible, MinIO error report, extra entities, notifications excluded).
