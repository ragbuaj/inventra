...
> 17. **Next: Wire Kantor + Lantai + Ruangan screens** (`/master/offices`, `/master/floors`, `/master/rooms`) — last of the master-data screen-wiring batch; will wire `useOffices` that the Pegawai screen already inline-fetches for the office picker.
