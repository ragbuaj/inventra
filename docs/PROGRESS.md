...
> 14. **Next: Wire Referensi screen** (11 generic resources via the reference engine) — add FK pickers for cities→province_id and models→brand_id; optionally expose `office_types.tier` as an editable field. This is the second sub-project in the master-data wiring batch.
