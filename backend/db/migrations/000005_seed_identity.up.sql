...
JOIN (VALUES
  ...
  ('superadmin', 'asset.create'),
  ('superadmin', 'asset.update'),
  ('superadmin', 'asset.delete'),
  ('superadmin', 'asset.read'),
  ('superadmin', 'asset.checkout'),
  ('superadmin', 'request.create'),
  ('superadmin', 'request.approve'),
  ...
  ('kepala_kanwil', 'asset.read'),
  ('kepala_kanwil', 'request.create'),
  ('kepala_kanwil', 'request.approve'),
  ...
  ('kepala_unit', 'asset.read'),
  ('kepala_unit', 'request.create'),
  ('kepala_unit', 'request.approve'),
